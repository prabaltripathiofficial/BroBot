  ...
  return (
    <div>
      <div className="flex h-screen">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 pb-8 bg-[#292a2d] text-white relative">
          ...
          {messages.length === 0 ? (
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-2xl font-medium">Hello Patty, I'm BroBot.</p>
            </div>
            <p className="text-sm mt-2">What are you curious about now?</p>
            </>
          ):
          (
        ...
        <p className="text-xs absolute bottom-1 text-gray-500">I am an AI Patty, So you can completely trust me!</p>
